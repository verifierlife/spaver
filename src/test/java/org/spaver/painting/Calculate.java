 ...
 * @author tengf
 */
public class Calculate extends Canvas{
	...
	public static void main(String[] args) {
		...
		removeNoise(0, 3);
		print();
		//new Calculate().findMaxBlackRect();// findMaxBlackRect();
	...
	public void findMaxBlackRect() {
		...
		g.fillOval(x1, y1, rwidth, rheight);//.fillOval(maxYPoint.x - 3, maxYPoint.y - 3, 6, 6);
